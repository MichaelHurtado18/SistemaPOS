                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="metricas.php">
                                ...
                                <i class="bi bi-bar-chart" style="font-size: 1.5rem;"></i> Metricas
                            </a>
                        </li>
                ...
                <div class="graficos_bg">
                    <div class="card">
                        <div class="d-flex justify-content-sm-around">
                            <input class="form-control" type="date" id="fecha_1">
                            <input class="form-control" type="date" id="fecha_2">
                        </div>
                        ...
                        <div class="card-body">
                            <div class="grafica_b">
                                <canvas id="metrica_1"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="d-flex justify-content-sm-around">
                            <input class="form-control" type="date" id="fecha_3">
                            <input class="form-control" type="date" id="fecha_4">
                        </div>
                        <div class="card-header">
                            Grafico 2
                        </div>
